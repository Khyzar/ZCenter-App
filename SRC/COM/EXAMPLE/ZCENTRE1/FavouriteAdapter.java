...
public class FavouriteAdapter extends ArrayAdapter<Product>
{
	Context c;
    int layoutFile;
    ArrayList<Product> DataList;
    ArrayList<Bitmap> Images;
    public FavouriteAdapter (Context context, int resource, ArrayList<Product> objects,ArrayList<Bitmap> i)
    {
...
//				 db.deleteProduct(DataList.get(position));
//				 Toast.makeText(c, "Product Deleted from Favourites.",Toast.LENGTH_SHORT).show();
